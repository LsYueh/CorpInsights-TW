CREATE TABLE IF NOT EXISTS t187ap07_bd_{COMPANY_CODE} (
    -- 1. 核心識別與索引欄位
    ...
    retained_earnings_or_accumulated_losses DECIMAL(20, 2) DEFAULT 0.00 COMMENT '保留盈餘（或累積虧損）',
    other_equity DECIMAL(20, 2) DEFAULT 0.00 COMMENT '其他權益',
    treasury_stock DECIMAL(20, 2) DEFAULT 0.00 COMMENT '庫藏股票',
    equity_attributable_to_owners DECIMAL(20, 2) DEFAULT 0.00 COMMENT '歸屬於母公司業主權益合計',
    ...
    parent_subsidiary_treasury_shares DECIMAL(20, 2) DEFAULT 0.00 COMMENT '母公司暨子公司持有之母公司庫藏股股數（單位：股）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公發公司資產負債表-證券期貨業 (公司 {COMPANY_CODE})';