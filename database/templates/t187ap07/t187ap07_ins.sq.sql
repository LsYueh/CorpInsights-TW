CREATE TABLE IF NOT EXISTS t187ap07_ins_{COMPANY_CODE} (
    ...
    assets_to_be_distributed_to_owners_or_disposal_groups DECIMAL(20, 2) DEFAULT 0.00 COMMENT '待分配予業主之資產（或處分群組）',
    ...
    assets_on_segregated_accounts_insurance_products DECIMAL(20, 2) DEFAULT 0.00 COMMENT '分離帳戶保險商品資產',
    ...
    insurance_contract_reserves_of_financial_product_nature DECIMAL(20, 2) DEFAULT 0.00 COMMENT '具金融商品性質之保險契約準備',
    ...
    liabilities_on_segregated_accounts_insurance_products DECIMAL(20, 2) DEFAULT 0.00 COMMENT '分離帳戶保險商品負債',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公發公司資產負債表-保險業 (公司 {COMPANY_CODE})';