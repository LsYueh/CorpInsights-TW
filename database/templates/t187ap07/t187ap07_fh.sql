CREATE TABLE IF NOT EXISTS t187ap07_fh_{COMPANY_CODE} (
    -- 1. 核心識別與索引欄位
    ...
    derivative_financial_assets_for_hedging DECIMAL(20, 2) DEFAULT 0.00 COMMENT '避險之衍生金融資產',
    securities_purchased_under_resale_agreements DECIMAL(20, 2) DEFAULT 0.00 COMMENT '附賣回票券及債券投資',
    ...
    blank_field VARCHAR(1) DEFAULT NULL COMMENT '空格 (原始 JSON 佔位欄位)',
    ...
    equity_attributable_to_owners DECIMAL(20, 2) DEFAULT 0.00 COMMENT '歸屬於母公司業主之權益',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公發公司資產負債表-金控業 (公司 {COMPANY_CODE})';