CREATE TABLE IF NOT EXISTS t187ap06_bd_{COMPANY_CODE} (
    -- 1. 核心識別與索引欄位
    ...
    -- 2. 證券期貨業主要營業損益項目
    revenues DECIMAL(20, 2) DEFAULT 0.00 COMMENT '收益',
    expenses_and_costs DECIMAL(20, 2) DEFAULT 0.00 COMMENT '支出及費用',
    operating_income DECIMAL(20, 2) DEFAULT 0.00 COMMENT '營業利益',
    non_operating_income_and_expenses DECIMAL(20, 2) DEFAULT 0.00 COMMENT '營業外損益',
    ...
    -- 5. 損益歸屬項目
    net_income_attributable_to_owners_of_parent DECIMAL(20, 2) DEFAULT 0.00 COMMENT '淨利（損）歸屬於母公司業主',
    net_income_attributable_to_predecessor_interests DECIMAL(20, 2) DEFAULT 0.00 COMMENT '淨利（淨損）歸屬於共同控制下前手權益',
    net_income_attributable_to_non_controlling_interests DECIMAL(20, 2) DEFAULT 0.00 COMMENT '淨利（損）歸屬於非控制權益',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公發公司綜合損益表-證券期貨業 (公司 {COMPANY_CODE})';