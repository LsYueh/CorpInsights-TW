CREATE TABLE IF NOT EXISTS t187ap06_fh_{COMPANY_CODE} (
    -- 1. 核心識別與索引欄位
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公發公司綜合損益表-金控業 (公司 {COMPANY_CODE})';