CREATE TABLE IF NOT EXISTS t187ap07_fh (
    ...
    derivative_financial_assets_for_hedging_net DECIMAL(20, 2) DEFAULT 0.00 COMMENT '避險之衍生金融資產淨額',
    reverse_repo_net            DECIMAL(20, 2) DEFAULT 0.00 COMMENT '附賣回票券及債券投資淨額',
    ...
    assets_for_distribution_net DECIMAL(20, 2) DEFAULT 0.00 COMMENT '待分配予業主之資產－淨額',
    discounts_and_loans_net     DECIMAL(20, 2) DEFAULT 0.00 COMMENT '貼現及放款－淨額',
    reinsurance_contract_assets_net     DECIMAL(20, 2) DEFAULT 0.00 COMMENT '再保險合約資產－淨額',
    investments_using_equity_method_net DECIMAL(20, 2) DEFAULT 0.00 COMMENT '採用權益法之投資－淨額',
    ...
    investment_property_net     DECIMAL(20, 2) DEFAULT 0.00 COMMENT '投資性不動產－淨額',
    ...
    derivative_financial_liabilities_for_hedging_net DECIMAL(20, 2) DEFAULT 0.00 COMMENT '避險之衍生金融負債',
    repo_liabilities             DECIMAL(20, 2) DEFAULT 0.00 COMMENT '附買回票券及債券負債',
