CREATE TABLE IF NOT EXISTS t187ap07_basi (
    ...
    derivative_financial_liabilities_for_hedging_net DECIMAL(20, 2) DEFAULT 0.00 COMMENT '避險之衍生金融負債－淨額',
    ...
    total_equity_amount       DECIMAL(20, 2) DEFAULT 0.00 COMMENT '權益總計',
