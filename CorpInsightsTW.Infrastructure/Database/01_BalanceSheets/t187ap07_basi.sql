CREATE TABLE IF NOT EXISTS t187ap07_basi (
    ...
    investment_property     DECIMAL(20, 2) DEFAULT 0.00 COMMENT '投資性不動產投資－淨額',
    ...
    derivative_financial_liabs_for_hedging DECIMAL(20, 2) DEFAULT 0.00 COMMENT '避險之衍生金融負債－淨額',
