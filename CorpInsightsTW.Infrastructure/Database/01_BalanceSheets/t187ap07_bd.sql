CREATE TABLE IF NOT EXISTS `t187ap07_bd` (
    ...
    `retained_earnings`                           DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '保留盈餘 / 保留盈餘（或累積虧損）',
    ...
    `total_equity`                                DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '權益總額 / 權益總計',
    ...
    `parent_subsidiary_treasury_shares`           DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '母公司暨子公司持有之母公司庫藏股股數（單位：股）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公司資產負債表-證券期貨業';