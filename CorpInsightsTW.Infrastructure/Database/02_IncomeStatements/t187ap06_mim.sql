CREATE TABLE IF NOT EXISTS `t187ap06_mim` (
    ...
    -- 2. 異業最精簡之收支項目
    `revenues`                                    DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '收入',
    `expenses`                                    DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '支出',
    ...
    -- 4. 其他綜合損益項目
    `other_comprehensive_income`                  DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '其他綜合損益',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公司綜合損益表-異業';