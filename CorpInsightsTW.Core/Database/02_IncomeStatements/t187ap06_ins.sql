CREATE TABLE IF NOT EXISTS `t187ap06_ins` (
    ...
    -- 2. 保險業營業損益項目
    `operating_revenue`                           DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '營業收入',
    `operating_costs`                             DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '營業成本',
    ...
    -- 3. 稅前與稅後純益項目
    `income_before_tax`                           DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '繼續營業單位稅前純益（純損）',
    `income_tax`                                  DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '所得稅費用（利益）',
    `income_after_tax`                            DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '繼續營業單位本期純益（純損）',
    ...
    -- 4. 其他綜合損益項目
    `other_comprehensive_income`                  DECIMAL(20, 2)  NOT NULL DEFAULT 0.00 COMMENT '其他綜合損益（淨額/稅後淨額）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公司綜合損益表-保險業';